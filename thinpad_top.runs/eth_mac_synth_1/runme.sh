...
HD_PWD='C:/workspace/Network/thinpad_top/thinpad_top.runs/eth_mac_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log eth_mac.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source eth_mac.tcl
