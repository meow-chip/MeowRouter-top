...
module meowrouter_blk_mem_gen_0_0(clka, rsta, ena, wea, addra, dina, douta, clkb, enb, web, 
  addrb, dinb, doutb, rsta_busy, rstb_busy)
/* synthesis syn_black_box black_box_pad_pin="clka,rsta,ena,wea[3:0],addra[11:0],dina[31:0],douta[31:0],clkb,enb,web[0:0],addrb[13:0],dinb[7:0],doutb[7:0],rsta_busy,rstb_busy" */;
  input clka;
  input rsta;
  input ena;
  input [3:0]wea;
